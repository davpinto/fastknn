#' Chess Dataset
#'
#' Bidimensional binary dataset to be used as a toy example.
#'
#' @format A data.frame with 2000 rows and 3 variables:
#' \describe{
#'   \item{x1}{randomly generated numeric feature}
...
#'
#' Bidimensional multiclass dataset to be used as a toy example.
#'
#' @format A data.frame with 2000 rows and 3 variables:
#' \describe{
#'   \item{x1}{randomly generated numeric feature}
...
#' Covertype Data
#'
#' Sample of size 50k from the multiclass dataset Covertype hosted in the UCI repository.
#'
